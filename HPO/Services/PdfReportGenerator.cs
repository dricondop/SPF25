...
namespace HeatProductionOptimization.Services
{
    public static class PdfReportGenerator
    {
        public static async Task GenerateReport(ResultsData data, Stream outputStream)
        {
                        ...
                        .Column(column =>
                        {
                            ...
                            column.Item()
                                ...
                                .Column(summaryColumn =>
                                {
                                    ...
                                    {
                                        row.RelativeItem().Text("Time Period:");
                                        row.RelativeItem().Text($"{data.TimeStamps.First():yyyy-MM-dd} to {data.TimeStamps.Last():yyyy-MM-dd}").SemiBold();
                                    });
                                    ...
                                    summaryColumn.Item().Row(row =>
                                    {
                                        ...
                                        row.RelativeItem().Text($"{data.HeatDemand.Average():F2} MWh").SemiBold();
                                    });
                            ...
                            // Charts Section
                            if (data.ElectricityPriceChartImage != null)
                            {
                                ...
                                column.Item()
                                    ...
                                    .Column(chartColumn =>
                                    {
                                        ...
                                        chartColumn.Item().Height(200).Image(data.ElectricityPriceChartImage);
                                    });
                            }

                            if (data.HeatDemandChartImage != null)
                            {
                                ...
                                column.Item()
                                    ...
                                    .Column(chartColumn =>
                                    {
                                        ...
                                        chartColumn.Item().Text("Demand (MWh)").FontSize(10).FontColor(Colors.Grey.Darken1);
                                        chartColumn.Item().Height(200).Image(data.HeatDemandChartImage);
                                    });
                            }

                            if (data.ProductionDistributionChartImage != null)
                            {
                                column.Item().PageBreak();
                                column.Item()
                                    .Border(1)
                                    ...
                                    .Column(chartColumn =>
                                    {
                                        ...
                                        chartColumn.Item().Height(200).Image(data.ProductionDistributionChartImage);
                                    });
                            }

                            if (data.EmissionsChartImage != null)
                            {
                                column.Item().PaddingTop(15);
                                column.Item()
                                    .Border(1)
                                    ...
                                    .Column(chartColumn =>
                                    {
                                        ...
                                        chartColumn.Item().Height(200).Image(data.EmissionsChartImage);
                                    });
                            }
            ...
            await Task.Run(() => document.GeneratePdf(outputStream));
        }
    }
}