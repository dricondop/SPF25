...
namespace HeatProductionOptimization.Services.DataProviders
{
    public class ResultsData
    {
        ...
        // Add properties for chart images
        public byte[] HeatDemandChartImage { get; set; }
        public byte[] ElectricityPriceChartImage { get; set; }
        public byte[] ProductionDistributionChartImage { get; set; }
        public byte[] EmissionsChartImage { get; set; }
        ...
        public void Clear()
        {
            ...
            HeatDemandChartImage = null;
            ElectricityPriceChartImage = null;
            ProductionDistributionChartImage = null;
            EmissionsChartImage = null;
        }
    }
}